...
def login():
    ...
    return '''<body style="background:#003366;color:white;text-align:center;padding-top:100px;font-family:Impact;">
        ...
        <form method="post"><input type="hidden" name="csrf_token" value="''' + os.urandom(16).hex() + '''">
...
@login_required
@csrf.exempt # Desactivamos temporalmente el token en admin para evitar el "Bad Request"
def admin():
    if request.method == 'POST':
        nueva = Noticia(
    ...
    return '''<script src="https://cdn.ckeditor.com/4.25.1-lts/full/ckeditor.js"></script>
    <body style="background:#f4f4f4;padding:20px;font-family:sans-serif;">
        <div style="max-width:900px;margin:auto;background:white;padding:25px;border-radius:15px;box-shadow:0 0 15px rgba(0,0,0,0.2);">
            ...
            <form method="post">
                ...
                <input type="text" name="imagen_url" placeholder="URL Foto" style="width:100%;padding:10px;margin-bottom:10px;">
