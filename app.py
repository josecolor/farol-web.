...
<body>
<nav class="navbar navbar-dark mb-5 shadow-lg"><div class="container"><a class="navbar-brand" href="/">🏮 EL FAROL</a></div></nav>
<div class="container">
    <div class="row">
        {% if noticias %}
                    ...
                    <div class="card card-noticia">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="/uploads/{{ noticia.autor.foto_perfil }}" style="width:25px; height:25px; border-radius:50%; margin-right:10px;">
                                <span class="text-warning" style="font-size:0.75rem;">{{ noticia.autor.nombre_publico }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<body style="background:#0a0a0a; color:white; font-family:sans-serif; text-align:center; padding-top:100px;">
    ...
    <form method="post" style="background:#1a1a1a; display:inline-block; padding:40px; border-radius:20px; border:1px solid #333;">
        <h3>Acceso de Redacción</h3>
        <input name="user" placeholder="Usuario" style="width:100%; padding:10px; margin-bottom:10px;"><br>
        <input name="password" type="password" placeholder="Clave" style="width:100%; padding:10px; margin-bottom:20px;"><br>
        <button type="submit" style="width:100%; padding:10px; background:#ff8c00; border:none; font-weight:bold;">ENTRAR AL PANEL</button>
    </form>
</body>
'''
