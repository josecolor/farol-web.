/**
 * 🏮 EL FAROL AL DÍA — V34.7
 * Base: V34.6
 * Cambios:
 *   1. Watermark: busca WATERMARK(1).png como nombre prioritario exacto
 *   2. Gemini: modelo gemini-2.5-flash, URL v1beta, AbortController 60s correcto
...
const CONFIG_IA_DEFAULT = {
    ...
    tono:                  'profesional',
    extension:             'media',
    enfasis:               'Si la noticia es nacional: prioriza SDE, Los Mina, Invivienda, Ensanche Ozama. Si es internacional: conecta con el impacto en RD y el Caribe.',
...
// ─── PEXELS ───────────────────────────────────────────────────────────────────
const PEXELS_BLOQ = ['wedding','bride','groom','couple','romance','flowers','fashion','pet','dog','cat','birthday','party'];
...
Eres el editor jefe de El Farol al Dia. Periodismo dominicano profesional: datos concretos, fuentes verificables, impacto real para el ciudadano. Escribe como el Listin Diario o Diario Libre: serio, sin sensacionalismo.
${memoria}
${contextoWiki}
${fuenteContenido}
...
ESTRUCTURA OBLIGATORIA (pirámide invertida):
- Párrafo 1 LEAD: Qué + Quién + Cuándo + Dónde + Por qué (3 líneas máx)
- Párrafo 2 CONTEXTO: Datos concretos con cifras verificables de RD
- Párrafo 3 FUENTES: Citar institución oficial dominicana con verbos de atribución
- Párrafo 4 IMPACTO ECONÓMICO: Qué cambia para el ciudadano. Mencionar NATURALMENTE: ${termCPC}
...
- QUERY_IMAGEN: 3-4 palabras en inglés, escena periodística (NO bodas mascotas moda)
- ALT_IMAGEN: 15-20 palabras en español con contexto RD

RESPONDE EXACTAMENTE EN ESTE FORMATO (sin asteriscos ni markdown):
TITULO: [60-70 chars]
DESCRIPCION: [150-160 chars SEO]
PALABRAS: [5 keywords, primera: republica dominicana]
QUERY_IMAGEN: [inglés 3-4 palabras]
ALT_IMAGEN: [español 15-20 palabras con RD]
...
CONTENIDO:
[400-500 palabras, 5 párrafos separados por línea en blanco]`;
